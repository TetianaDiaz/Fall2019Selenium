...
public void verifyTitle(){
    ...
    String actual = js.executeScript("return document.title").toString();//we can add toString or do casting
  ...
  //dissable this click action, to perform it with js executor
 // link.click();
  JavascriptExecutor js = (JavascriptExecutor) driver;
  //after "" you can list webelements that will be used
       ...
       //WebElement agruments = {element, link, link2};
       //from left - to right
...
public void scrollTest(){
        driver.navigate().to("https://practice-cybertekschool.herokuapp.com/infinite_scroll");
        JavascriptExecutor js = (JavascriptExecutor) driver;
    for (int i = 0; i < 15 ; i++) {
