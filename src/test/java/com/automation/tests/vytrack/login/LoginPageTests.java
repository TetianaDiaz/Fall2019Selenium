...
public class LoginPageTests {
    ...
    public void invalidUsername(){
        ...
        assertTrue(warningElement.isDisplayed());//if warning message in not visible, test will fail
    ...
    @Test(description = "Login as store manager and verify that tile is equal to Dashboard")
    public void loginAsStoreManager(){
        ...
        assertEquals(actual, expected, "Page tit;e is not correct!");
    }
